...
@section('title', 'Selecionar Empresa - Rotas')
...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <div class="px-6 py-5 border-b border-gray-200">
        ...
        <p class="text-sm text-gray-600 mt-1">Como administrador global, escolha a empresa para gerenciar as rotas.</p>
    </div>
                ...
                @forelse($tenants as $tenant)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm">
                            <a href="{{ route('portal.transport-routes.index', ['company' => $tenant->uid]) }}" class="inline-flex items-center px-3 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition font-medium">Abrir rotas</a>
                        </td>
                    </tr>
                @empty
                    <tr>
